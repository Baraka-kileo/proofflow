...
export function ApplicationDetailsReceipt({
  buyer,
  purchaseOrder,
  amount,
  dueDate,
    ...
    <Card>
      <CardContent className="pt-6">
        ...
        <dl className="mt-5 grid gap-3 sm:grid-cols-2">
          <Detail label="Large customer" value={buyer} />
          <Detail
            label="Purchase order"
            value={purchaseOrder ?? "Not provided"}
          />
          <Detail label="Invoice value" value={amount} />
